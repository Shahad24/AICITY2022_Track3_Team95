...
def multiple_samples_collate(batch, fold=False):
    ...
    # print(' before multiple_samples_collate inputs = ', len(inputs))
    # print(' before multiple_samples_collate labels = ', len(labels))

    inputs = [item for sublist in inputs for item in sublist]
    labels = [item for sublist in labels for item in sublist]
    # print(' after multiple_samples_collate inputs = ', len(inputs))
    # print(' after multiple_samples_collate labels = ', len(labels))
...
def construct_loader(cfg, split, is_precise_bn=False):
    ...
    if isinstance(dataset, torch.utils.data.IterableDataset):
        print(' IterableDataset Dataset loader :)')
        ...
        if (
            ...
            print(' sampler distributed Dataset loader :)')
